...
targ_name = 'FPTau'
tag = 'B4_hi'
input_ms_name = 'FPTau_vis_B4_hi.ms' # name of measurement set to be copied

data_dir = top_dir + targ_name + '/' # eg. this would give /Volumes/disks/meerap/data/FPTau/
source_ms = data_dir + targ_name + '_vis_' + tag + '.ms' # eg. this would give /Volumes/disks/meerap/data/FPTau/FPTau_vis_B4_hi.ms
...
mscpy = out_fol + targ_name + '_vis_' + tag + '_wtfx.ms'
